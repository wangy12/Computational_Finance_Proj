...
strategy_names     = {'Buy and Hold' 'Equally Weighted Portfolio' 'Minimum Variance Portfolio' 'Maximum Sharpe Ratio Portfolio' 'Equal Risk Contributions Portfolio' 'Robust Optimization Portfolio'};
...
for (period = 1:N_periods)
   ...
   for(strategy = 1:N_strat)
      ...
      % Compute strategy
      [x{strategy,period}, cash{strategy,period}] = fh_array{strategy}(curr_positions, curr_cash, mu, Q, cur_prices, period, strategy);
